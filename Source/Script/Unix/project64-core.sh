...
#$CC -o $obj/7zip.asm                    $src/3rdParty/7zip.cpp $CPP_FLAGS # precompiled?
$CC -o $obj/AppInit.asm                 $src/AppInit.cpp $CPP_FLAGS
...
$CC -o $obj/N64System/interp/Ops.asm    $src/N64System/Interpreter/InterpreterOps.cpp $CPP_FLAGS
$CC -o $obj/N64System/interp/Ops32.asm  $src/N64System/Interpreter/InterpreterOps32.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Audio.asm    $src/N64System/Mips/Audio.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Disk.asm     $src/N64System/Mips/Disk.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Dma.asm      $src/N64System/Mips/Dma.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Eeprom.asm   $src/N64System/Mips/Eeprom.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/FlashRam.asm $src/N64System/Mips/FlashRam.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/GBCart.asm   $src/N64System/Mips/GBCart.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Memory.asm   $src/N64System/Mips/MemoryVirtualMem.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Mempak.asm   $src/N64System/Mips/Mempak.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/OpName.asm   $src/N64System/Mips/OpcodeName.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/PifRam.asm   $src/N64System/Mips/PifRam.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/RegClass.asm $src/N64System/Mips/RegisterClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Rumble.asm   $src/N64System/Mips/Rumblepak.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Sram.asm     $src/N64System/Mips/Sram.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/SyEvents.asm $src/N64System/Mips/SystemEvents.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/SyTiming.asm $src/N64System/Mips/SystemTiming.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/TLBclass.asm $src/N64System/Mips/TLBclass.cpp $CPP_FLAGS
$CC -o $obj/N64System/Mips/Transfer.asm $src/N64System/Mips/Transferpak.cpp $CPP_FLAGS
$CC -o $obj/N64System/N64Class.asm      $src/N64System/N64Class.cpp $CPP_FLAGS
$CC -o $obj/N64System/N64DiskClass.asm  $src/N64System/N64DiskClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/N64RomClass.asm   $src/N64System/N64RomClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/ProfileClass.asm  $src/N64System/ProfilingClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Block.asm $src/N64System/Recompiler/CodeBlock.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/CSect.asm $src/N64System/Recompiler/CodeSection.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/FnNfo.asm $src/N64System/Recompiler/FunctionInfo.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/FnMap.asm $src/N64System/Recompiler/FunctionMapClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Loop.asm  $src/N64System/Recompiler/LoopAnalysis.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Class.asm $src/N64System/Recompiler/RecompilerClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Mem.asm   $src/N64System/Recompiler/RecompilerMemory.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Ops.asm   $src/N64System/Recompiler/x86/x86RecompilerOps.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Reg.asm   $src/N64System/Recompiler/x86/x86RegInfo.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/Sect.asm  $src/N64System/Recompiler/SectionInfo.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/log.asm   $src/N64System/Recompiler/RecompilerCodeLog.cpp $CPP_FLAGS
$CC -o $obj/N64System/dynarec/x86op.asm $src/N64System/Recompiler/x86/x86ops.cpp $CPP_FLAGS
$CC -o $obj/N64System/SpeedLimiter.asm  $src/N64System/SpeedLimiterClass.cpp $CPP_FLAGS
$CC -o $obj/N64System/SystemGlobals.asm $src/N64System/SystemGlobals.cpp $CPP_FLAGS
$CC -o $obj/Plugins/Audio.asm           $src/Plugins/AudioPlugin.cpp $CPP_FLAGS
$CC -o $obj/Plugins/Controller.asm      $src/Plugins/ControllerPlugin.cpp $CPP_FLAGS
$CC -o $obj/Plugins/Graphics.asm        $src/Plugins/GFXPlugin.cpp $CPP_FLAGS
...
$CC -o $obj/Settings/type/RDBOnOff.asm  $src/Settings/SettingType/SettingsType-RDBOnOff.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RDBRamSz.asm  $src/Settings/SettingType/SettingsType-RDBRamSize.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RDBSaves.asm  $src/Settings/SettingType/SettingsType-RDBSaveChip.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RDBYesNo.asm  $src/Settings/SettingType/SettingsType-RDBYesNo.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RelPath.asm   $src/Settings/SettingType/SettingsType-RelativePath.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RomDb.asm     $src/Settings/SettingType/SettingsType-RomDatabase.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RomDbInx.asm  $src/Settings/SettingType/SettingsType-RomDatabaseIndex.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/RomDbSet.asm  $src/Settings/SettingType/SettingsType-RomDatabaseSetting.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/SelectDir.asm $src/Settings/SettingType/SettingsType-SelectedDirectory.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/TmpBool.asm   $src/Settings/SettingType/SettingsType-TempBool.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/TmpNumber.asm $src/Settings/SettingType/SettingsType-TempNumber.cpp $CPP_FLAGS
$CC -o $obj/Settings/type/TmpString.asm $src/Settings/SettingType/SettingsType-TempString.cpp $CPP_FLAGS
#$CC -o $obj/stdafx.asm                  $src/stdafx.cpp $CPP_FLAGS
